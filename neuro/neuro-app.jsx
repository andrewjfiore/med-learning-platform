...
const SpinalCordSVG = ({ highlight = [], lesionRegions = [], onClick, interactive = false, showLabels = true, size = 300 }) => {
  ...
  // All 14 tracts with anatomically accurate positions
  const tractDefs = [
    // POSTERIOR FUNICULUS - Dorsal Columns
    { key: "dorsalColumns", label: "DCML", short: "Gr/Cu", color: "#4A7A8A", 
      paths: [
        "M 197 130 L 197 155 Q 192 162 186 158 L 182 142 Q 184 132 197 130 Z",  // Gracilis L
        "M 203 130 L 203 155 Q 208 162 214 158 L 218 142 Q 216 132 203 130 Z",  // Gracilis R
        "M 182 142 L 186 158 Q 178 168 170 164 L 164 150 Q 168 138 182 142 Z",  // Cuneatus L  
        "M 218 142 L 214 158 Q 222 168 230 164 L 236 150 Q 232 138 218 142 Z", // Cuneatus R
      ],
      labelPos: [200, 124], sub: ["Gr", "Cu", "Cu"] },
    
    // LISSAUER'S TRACT - Dorsolateral
    { key: "lissauer", label: "Lissauer", color: "#E88A3A",
      paths: [
        "M 162 165 Q 156 172 152 180 Q 148 184 152 186 Q 158 182 164 175 Q 164 168 162 165 Z",
        "M 238 165 Q 244 172 248 180 Q 252 184 248 186 Q 242 182 236 175 Q 236 168 238 165 Z",
      ],
      labelPos: [130, 175] },
    
    // DORSAL SPINOCEREBELLAR TRACT
    { key: "dorsalSCT", label: "DSCT", color: "#2E8B57",
      paths: [
        "M 150 185 Q 142 196 138 212 Q 136 224 140 230 Q 148 226 148 214 Q 150 200 152 186 Z",
        "M 250 185 Q 258 196 262 212 Q 264 224 260 230 Q 252 226 252 214 Q 250 200 248 186 Z",
      ],
      labelPos: [116, 208] },
    
    // CUNEOCEREBELLAR TRACT
    { key: "cuneocerebellar", label: "CCT", color: "#66CDAA",
      paths: [
        "M 156 177 Q 150 185 146 194 Q 142 190 148 180 Q 152 174 156 177 Z",
        "M 244 177 Q 250 185 254 194 Q 258 190 252 180 Q 248 174 244 177 Z",
      ],
      labelPos: [118, 188] },
    
    // LATERAL CORTICOSPINAL TRACT (85-90%)
    { key: "lateralCST", label: "LCST", color: "#7B68AE",
      paths: [
        "M 140 230 Q 134 246 134 266 Q 136 284 144 294 Q 154 290 152 272 Q 150 254 148 232 Z",
        "M 260 230 Q 266 246 266 266 Q 264 284 256 294 Q 246 290 248 272 Q 250 254 252 232 Z",
      ],
      labelPos: [108, 264] },
    
    // RUBROSPINAL TRACT
    { key: "rubrospinal", label: "RST", color: "#CD5C5C",
      paths: [
        "M 144 294 Q 140 304 144 312 Q 152 314 154 306 Q 150 298 146 294 Z",
        "M 256 294 Q 260 304 256 312 Q 248 314 246 306 Q 250 298 254 294 Z",
      ],
      labelPos: [112, 306] },
    
    // LATERAL RETICULOSPINAL
    { key: "lateralReticulospinal", label: "Lat-RetST", color: "#D4A870",
      paths: [
        "M 144 312 Q 140 322 144 330 Q 152 332 154 324 Q 150 316 146 312 Z",
        "M 256 312 Q 260 322 256 330 Q 248 332 246 324 Q 250 316 254 312 Z",
      ],
      labelPos: [104, 326] },
    
    // SPINOTHALAMIC TRACT
    { key: "spinothalamic", label: "STT", color: "#C94040",
      paths: [
        "M 146 328 Q 140 340 144 354 Q 154 360 160 350 Q 156 340 150 330 Z",
        "M 254 328 Q 260 340 256 354 Q 246 360 240 350 Q 244 340 250 330 Z",
      ],
      labelPos: [118, 348] },
    
    // VENTRAL SPINOCEREBELLAR TRACT
    { key: "ventralSCT", label: "VSCT", color: "#3CB371",
      paths: [
        "M 144 352 Q 138 362 144 370 Q 152 372 156 364 Q 150 356 146 352 Z",
        "M 256 352 Q 262 362 256 370 Q 248 372 244 364 Q 250 356 254 352 Z",
      ],
      labelPos: [114, 366] },
    
    // VESTIBULOSPINAL TRACT
    { key: "vestibulospinal", label: "VeST", color: "#4682B4",
      paths: [
        "M 160 350 Q 154 362 160 374 Q 170 376 174 366 Q 168 356 162 350 Z",
        "M 240 350 Q 246 362 240 374 Q 230 376 226 366 Q 232 356 238 350 Z",
      ],
      labelPos: [140, 380] },
    
    // MEDIAL RETICULOSPINAL
    { key: "medialReticulospinal", label: "Med-RetST", color: "#B8A040",
      paths: [
        "M 176 358 Q 172 368 176 378 Q 184 380 188 372 Q 184 364 180 358 Z",
        "M 224 358 Q 228 368 224 378 Q 216 380 212 372 Q 216 364 220 358 Z",
      ],
      labelPos: [200, 394] },
    
    // ANTERIOR CORTICOSPINAL TRACT (10-15%)
    { key: "anteriorCST", label: "ACST", color: "#9B88CE",
      paths: [
        "M 190 348 Q 188 360 190 372 Q 196 374 198 364 Q 196 356 194 348 Z",
        "M 210 348 Q 212 360 210 372 Q 204 374 202 364 Q 204 356 206 348 Z",
      ],
      labelPos: [200, 358] },
    
    // TECTOSPINAL TRACT
    { key: "tectospinal", label: "TeST", color: "#BC8F8F",
      paths: [
        "M 196 374 Q 200 380 204 374 L 203 382 Q 200 386 197 382 Z",
      ],
      labelPos: [200, 400] },
  ];
  
  const isHighlighted = (key) => highlight.includes(key) || hovered === key;
  const isLesioned = (key) => lesionRegions.includes(key);
  
  return (
    <svg viewBox="80 100 240 320" width={size} style={{ maxWidth: "100%" }}>
      <defs>
        <radialGradient id="sc-bg" cx="50%" cy="46%" r="55%">
      ...
      {/* Cord outline */}
      <ellipse cx="200" cy="260" rx="80" ry="100" fill="url(#sc-bg)" stroke="#B8B0A0" strokeWidth="1.5" />
      
      {/* Gray matter - butterfly */}
      <path d="M 200 164 Q 192 172 184 180 Q 174 192 170 202 Q 166 212 168 222 Q 170 232 164 246 Q 158 260 156 274 Q 152 288 158 302 Q 166 318 176 328 Q 186 336 200 338 Q 214 336 224 328 Q 234 318 242 302 Q 248 288 244 274 Q 242 260 236 246 Q 230 232 232 222 Q 234 212 230 202 Q 226 192 216 180 Q 208 172 200 164 Z" fill="#C4BCA8" stroke="#A8A098" strokeWidth="0.8" />
      
      {/* Central canal */}
      <circle cx="200" cy="234" r="3" fill="#8BAAB4" stroke="#6A8A94" strokeWidth="0.6" />
      
      {/* Posterior median septum */}
      <line x1="200" y1="130" x2="200" y2="164" stroke="#A8A098" strokeWidth="0.8" opacity="0.7" />
      
      {/* Anterior median fissure */}
      <line x1="200" y1="338" x2="200" y2="372" stroke="#A8A098" strokeWidth="1.2" opacity="0.7" />
      
      {/* Tracts */}
      {tractDefs.map(tract => (
        <g key={tract.key}>
          {tract.paths.map((d, i) => {
            const active = isHighlighted(tract.key);
            const lesioned = isLesioned(tract.key);
            return (
              <path key={i} d={d}
                fill={active ? tract.color : tract.color + "40"}
                stroke={active ? tract.color : tract.color + "66"}
                strokeWidth={active ? 1.6 : 0.5}
                opacity={active ? 1 : 0.5}
                filter={active ? "url(#sc-glow)" : undefined}
                style={{ cursor: interactive || onClick ? "pointer" : "default", transition: "all 0.2s" }}
                onMouseEnter={() => setHovered(tract.key)}
                onMouseLeave={() => setHovered(null)}
                onClick={() => onClick && onClick(tract.key)}
              />
            );
          })}
        </g>
      ...
      {/* Labels */}
      {showLabels && (
        <g fontFamily="'DM Sans',system-ui,sans-serif">
          <text x="200" y="118" textAnchor="middle" fontSize="8" fontWeight="700" fill="#999">POSTERIOR</text>
          <text x="200" y="406" textAnchor="middle" fontSize="8" fontWeight="700" fill="#999">ANTERIOR</text>
          
          {tractDefs.map(tract => {
            const active = isHighlighted(tract.key);
            return (
              <text key={tract.key} x={tract.labelPos[0]} y={tract.labelPos[1]}
                textAnchor="middle" fontSize={active ? "8" : "6.5"} fontWeight="700"
                fill={active ? tract.color : "#888"} style={{ transition: "all 0.2s" }}>
                {tract.label}
              </text>
            );
          })}
          ...
          {/* Sub-labels for DCML */}
          {isHighlighted("dorsalColumns") && (
            <>
              <text x="200" y="152" textAnchor="middle" fontSize="6" fontWeight="600" fill="#4A7A8A">Gr</text>
              <text x="174" y="160" textAnchor="middle" fontSize="6" fontWeight="600" fill="#4A7A8A">Cu</text>
              <text x="226" y="160" textAnchor="middle" fontSize="6" fontWeight="600" fill="#4A7A8A">Cu</text>
            </>
          )}
        </g>
      )}
      ...
      {/* Hover tooltip */}
      {hovered && (
        <text x="200" y="420" textAnchor="middle" fontSize="9" fontWeight="700" 
          fill={tractDefs.find(t=>t.key===hovered)?.color || "#555"} fontFamily="'DM Sans',sans-serif">
          {tractDefs.find(t=>t.key===hovered)?.label}
        </text>
      )}
    </svg>
  );
  ...
  const [hovered, setHovered] = useState(null);
  const tractPaths = {
    dorsalColumns: { d: "M 140 60 Q 150 50 160 60 L 165 95 Q 150 100 135 95 Z", color: TRACTS.dorsalColumns.color, label: "DCML", lx: 150, ly: 55 },
    gracilis: { d: "M 144 62 Q 150 54 156 62 L 156 93 Q 150 97 144 93 Z", color: "#4A7A8A", label: "Gracilis", lx: 150, ly: 68 },
    cuneatus: { d: "M 135 65 L 144 62 L 144 93 L 135 95 Z", color: "#6B9BAA", label: "Cuneatus", lx: 128, ly: 75 },
    cuneatus2: { d: "M 165 65 L 156 62 L 156 93 L 165 95 Z", color: "#6B9BAA", label: "", lx: 172, ly: 75 },
    spinothalamicL: { d: "M 110 115 Q 105 130 110 145 Q 120 155 125 140 Q 120 125 115 115 Z", color: TRACTS.spinothalamic.color, label: "STT", lx: 95, ly: 130 },
    spinothalamicR: { d: "M 190 115 Q 195 130 190 145 Q 180 155 175 140 Q 180 125 185 115 Z", color: TRACTS.spinothalamic.color, label: "STT", lx: 198, ly: 130 },
    corticospinalL: { d: "M 125 100 Q 118 115 122 135 Q 130 140 133 125 Q 130 110 128 100 Z", color: TRACTS.lateralCST.color, label: "CST", lx: 108, ly: 105 },
    corticospinalR: { d: "M 175 100 Q 182 115 178 135 Q 170 140 167 125 Q 170 110 172 100 Z", color: TRACTS.lateralCST.color, label: "CST", lx: 185, ly: 105 },
    spinocerebellarL: { d: "M 118 90 Q 110 100 112 115 Q 116 118 120 110 Q 122 100 120 90 Z", color: TRACTS.dorsalSCT.color, label: "SCT", lx: 98, ly: 95 },
    spinocerebellarR: { d: "M 182 90 Q 190 100 188 115 Q 184 118 180 110 Q 178 100 180 90 Z", color: TRACTS.dorsalSCT.color, label: "SCT", lx: 194, ly: 95 },
    anteriorHornL: { d: "M 130 140 Q 118 145 115 155 Q 118 160 128 155 Q 135 148 130 140 Z", color: "#888", label: "", lx: 0, ly: 0 },
    anteriorHornR: { d: "M 170 140 Q 182 145 185 155 Q 182 160 172 155 Q 165 148 170 140 Z", color: "#888", label: "", lx: 0, ly: 0 },
  };

  const lesionOverlays = {
    "left-lateral": "M 110 80 Q 100 110 105 140 Q 115 165 130 155 Q 135 140 133 120 Q 132 95 125 80 Z",
    "left-posterior": "M 125 60 Q 130 55 150 50 L 150 100 Q 140 100 130 95 L 125 80 Z",
    "left-anterior": "M 125 140 Q 118 150 115 160 Q 130 170 150 172 L 150 140 Z",
    "right-lateral": "M 190 80 Q 200 110 195 140 Q 185 165 170 155 Q 165 140 167 120 Q 168 95 175 80 Z",
    "right-posterior": "M 175 60 Q 170 55 150 50 L 150 100 Q 160 100 170 95 L 175 80 Z",
    "right-anterior": "M 175 140 Q 182 150 185 160 Q 170 170 150 172 L 150 140 Z",
    center: "M 140 100 Q 145 95 150 93 Q 155 95 160 100 L 162 130 Q 155 140 150 142 Q 145 140 138 130 Z",
    posterior: "M 130 58 Q 140 48 150 45 Q 160 48 170 58 L 172 95 Q 160 102 150 104 Q 140 102 128 95 Z",
    "anterior-bilateral": "M 108 115 Q 105 135 110 155 Q 125 170 150 175 Q 175 170 190 155 Q 195 135 192 115 L 185 115 Q 178 125 175 140 Q 170 148 150 148 Q 130 148 125 140 Q 122 125 115 115 Z",
    "lateral-bilateral": "M 110 80 Q 100 110 105 140 Q 115 155 130 150 Q 133 135 132 110 L 168 110 Q 167 135 170 150 Q 185 155 195 140 Q 200 110 190 80 Q 182 70 175 80 L 172 95 Q 170 105 168 110 L 132 110 Q 130 105 128 95 L 125 80 Q 118 70 110 80 Z",
  };

  return (
    <svg viewBox="60 20 180 180" width={size} height={size} style={{ filter: "drop-shadow(0 2px 8px rgba(0,0,0,0.08))" }}>
      <defs>
        <radialGradient id="cord-grad" cx="50%" cy="45%" r="55%">
      ...
      {/* Outer cord shape */}
      <ellipse cx="150" cy="110" rx="55" ry="70" fill="url(#cord-grad)" stroke="#b0a89c" strokeWidth="1.5" />
      {/* Gray matter butterfly */}
      <path d="M 150 70 Q 140 80 130 90 Q 120 100 125 115 Q 130 130 120 145 Q 115 155 120 160 Q 135 170 150 170 Q 165 170 180 160 Q 185 155 180 145 Q 170 130 175 115 Q 180 100 170 90 Q 160 80 150 70 Z" fill="#c4beb4" stroke="#a09888" strokeWidth="0.8" />
      {/* Central canal */}
      <circle cx="150" cy="110" r="3" fill="#8aaab4" stroke="#6a8a94" strokeWidth="0.5" />
      {/* Tracts */}
      {Object.entries(tractPaths).map(([key, t]) => {
        const parentTract = key.replace(/[LR2]$/, '').replace(/[0-9]+$/, '');
        const isHighlighted = highlight.includes(key) || highlight.includes(parentTract) || highlight.some(h => key.startsWith(h));
        const isHov = hovered === key;
        return (
          <g key={key}>
            <path d={t.d} fill={isHighlighted ? t.color : `${t.color}55`} stroke={isHighlighted ? t.color : `${t.color}88`} strokeWidth={isHighlighted ? 1.5 : 0.8} opacity={isHighlighted ? 1 : 0.5} filter={isHov ? "url(#glow)" : undefined}
              style={{ cursor: interactive ? "pointer" : "default", transition: "all 0.3s" }}
              onClick={() => onClick?.(key)} onMouseEnter={() => setHovered(key)} onMouseLeave={() => setHovered(null)} />
            {showLabels && t.label && isHighlighted && (
              <text x={t.lx} y={t.ly} textAnchor="middle" fontSize="7" fontWeight="700" fill={t.color} fontFamily={FONTS}>{t.label}</text>
            )}
          </g>
        );
      })}
      {/* Lesion overlays */}
      {lesionRegions.map((region, i) => (
        <path key={i} d={lesionOverlays[region] || ""} fill="rgba(201,112,112,0.35)" stroke="#C97070" strokeWidth="1" strokeDasharray="3,2" />
      ))}
    </svg>
  );
};
...
const BrainstemSVG = ({ level = "midbrain", highlight = null, size = 280 }) => {
  const configs = {
    midbrain: {
      structures: [
        { name: "Cerebral peduncle", d: "M 60 140 Q 80 160 110 165 L 110 140 Q 90 135 60 140 Z", color: "#7B68AE", x: 50, y: 155 },
        { name: "Cerebral peduncle", d: "M 220 140 Q 200 160 170 165 L 170 140 Q 190 135 220 140 Z", color: "#7B68AE", x: 210, y: 155 },
        { name: "Substantia nigra", d: "M 105 130 Q 120 138 140 140 Q 160 138 175 130 L 175 125 Q 160 132 140 134 Q 120 132 105 125 Z", color: "#444", x: 140, y: 140 },
        { name: "Red nucleus", d: "M 125 105 A 12 12 0 1 1 125 107 Z", color: "#C97070", x: 115, y: 95 },
        { name: "Red nucleus", d: "M 155 105 A 12 12 0 1 1 155 107 Z", color: "#C97070", x: 168, y: 95 },
        { name: "CN III nucleus", d: "M 135 78 A 6 6 0 1 1 135 80 Z", color: COLORS.accent, x: 120, y: 73 },
        { name: "Aqueduct", d: "M 137 90 A 5 5 0 1 0 143 90 A 5 5 0 1 0 137 90 Z", color: "#8aaab4", x: 140, y: 92 },
        { name: "Sup. colliculus", d: "M 115 55 Q 140 40 165 55 Q 165 70 140 78 Q 115 70 115 55 Z", color: COLORS.sage, x: 140, y: 55 },
      ],
      outline: "M 60 140 Q 50 110 60 80 Q 80 45 140 35 Q 200 45 220 80 Q 230 110 220 140 Q 200 165 140 170 Q 80 165 60 140 Z",
    },
    pons: {
      structures: [
        { name: "Basilar pons", d: "M 70 140 Q 100 170 140 175 Q 180 170 210 140 L 210 120 Q 180 150 140 155 Q 100 150 70 120 Z", color: COLORS.blue, x: 140, y: 158 },
        { name: "CN VII nucleus", d: "M 105 100 A 8 8 0 1 1 105 102 Z", color: COLORS.accent, x: 88, y: 95 },
        { name: "CN VI nucleus", d: "M 130 88 A 5 5 0 1 1 130 90 Z", color: "#6BAF7B", x: 120, y: 82 },
        { name: "CN V nucleus", d: "M 80 95 A 10 8 0 1 1 80 97 Z", color: COLORS.pink, x: 60, y: 90 },
        { name: "4th ventricle", d: "M 120 55 Q 140 45 160 55 L 160 75 Q 140 82 120 75 Z", color: "#8aaab4", x: 140, y: 60 },
        { name: "MCP", d: "M 55 90 Q 45 110 55 130 Q 65 140 75 130 Q 70 110 75 90 Z", color: COLORS.beige, x: 40, y: 110 },
        { name: "MCP", d: "M 225 90 Q 235 110 225 130 Q 215 140 205 130 Q 210 110 205 90 Z", color: COLORS.beige, x: 230, y: 110 },
      ],
      outline: "M 55 90 Q 50 60 80 40 Q 110 30 140 28 Q 170 30 200 40 Q 230 60 225 90 Q 235 110 225 130 Q 210 160 140 175 Q 70 160 55 130 Q 45 110 55 90 Z",
    },
    medulla: {
      structures: [
        { name: "Pyramid", d: "M 120 140 Q 130 155 140 158 Q 150 155 160 140 L 158 125 Q 150 130 140 132 Q 130 130 122 125 Z", color: "#7B68AE", x: 140, y: 150 },
        { name: "Olive", d: "M 90 105 Q 80 120 85 140 Q 95 150 105 140 Q 110 120 105 105 Z", color: COLORS.beige, x: 78, y: 125 },
        { name: "Olive", d: "M 190 105 Q 200 120 195 140 Q 185 150 175 140 Q 170 120 175 105 Z", color: COLORS.beige, x: 200, y: 125 },
        { name: "Nucleus gracilis", d: "M 130 55 A 8 6 0 1 1 130 57 Z", color: "#5B8A9A", x: 118, y: 48 },
        { name: "Nucleus cuneatus", d: "M 110 65 A 8 6 0 1 1 110 67 Z", color: "#6B9BAA", x: 95, y: 58 },
        { name: "CN XII nucleus", d: "M 135 78 A 5 5 0 1 1 135 80 Z", color: COLORS.accent, x: 122, y: 73 },
        { name: "4th ventricle", d: "M 115 60 Q 140 48 165 60 L 165 78 Q 140 85 115 78 Z", color: "#8aaab4", x: 140, y: 62 },
        { name: "Nuc. solitarius", d: "M 118 90 A 6 4 0 1 1 118 92 Z", color: COLORS.sage, x: 102, y: 86 },
      ],
      outline: "M 75 95 Q 70 65 90 45 Q 110 32 140 28 Q 170 32 190 45 Q 210 65 205 95 Q 215 120 205 145 Q 190 168 140 175 Q 90 168 75 145 Q 65 120 75 95 Z",
    },
  };
  const cfg = configs[level];
  return (
    <svg viewBox="20 15 240 175" width={size} height={size * 0.72} style={{ filter: "drop-shadow(0 2px 8px rgba(0,0,0,0.08))" }}>
      <defs>
        <radialGradient id={`bs-grad-${level}`} cx="50%" cy="45%" r="55%">
          <stop offset="0%" stopColor="#f5f0e8" /><stop offset="100%" stopColor="#e0d8cc" />
        </radialGradient>
      </defs>
      <path d={cfg.outline} fill={`url(#bs-grad-${level})`} stroke="#b0a89c" strokeWidth="1.5" />
      {cfg.structures.map((s, i) => (
        <g key={i}>
          <path d={s.d} fill={`${s.color}88`} stroke={s.color} strokeWidth="1" />
          <text x={s.x} y={s.y} textAnchor="middle" fontSize="6" fill={COLORS.text} fontFamily={FONTS} fontWeight="600">{s.name}</text>
        </g>
      ))}
    </svg>
  );
        ...
        {phase === "identify" && targetTract && (
          <>
            ...
            <div style={{ display: "flex", justifyContent: "center", margin: "16px 0" }}>
              <SpinalCordSVG highlight={[]} interactive onClick={(key) => checkAnswer(key)} size={340} showLabels={false} />
            </div>
...
function LesionSimulator({ addXp }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <p style={{ color: COLORS.textLight, margin: 0, fontSize: 14 }}>Select a lesion pattern to see the affected regions and predicted deficits.</p>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div style={{ display: "flex", gap: 8 }}>
        ...
        <Btn onClick={() => { setShowReceptors(!showReceptors); addXp(5, "autonomic"); }} variant={showReceptors ? "secondary" : "ghost"}>Receptors</Btn>
      </div>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <Card>
        ...
        <p style={{ fontSize: 15.5, lineHeight: 1.7, fontWeight: 500, marginBottom: 20 }}>{q.q}</p>
