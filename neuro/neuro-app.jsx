...
const SpinalLevelsGallery = ({ selectedLevel, onSelect }) => {
  const levels = [
    { id: "overview", label: "All Levels", img: "img/sc-all-levels-wellcome.jpg", 
      desc: "Wellcome Collection ink-stain: transverse sections showing C-spine, thoracic, lumbar, sacral levels. Note progressive decrease in white matter, size changes in ventral horns (limb innervation), lateral horn presence in thoracic.",
      regions: [
        { id: "cervical", label: "Cervical", y: "5%", h: "20%", color: "#4A7A8A", desc: "C1-C8: Large oval, thick white matter, big ventral horns for arms" },
        { id: "upper-thoracic", label: "Upper Thoracic", y: "30%", h: "15%", color: "#7B68AE", desc: "T1-T6: Small round, lateral horn (sympathetic), narrow ventral horns" },
        { id: "lower-thoracic", label: "Lower Thoracic", y: "45%", h: "15%", color: "#C94040", desc: "T7-T12: Similar to upper, smaller ventral horns" },
        { id: "lumbar", label: "Lumbar", y: "62%", h: "18%", color: "#2E8B57", desc: "L1-S2: Large enlargement for legs, massive ventral horns" },
        { id: "sacral", label: "Sacral", y: "82%", h: "15%", color: "#E8A838", desc: "S3-Co1: Small, mostly gray matter, autonomic nuclei" },
      ]},
    { id: "cervical", label: "Cervical", img: "img/sc-cervical-cross.svg",
      desc: "C5-T1 enlargement: Largest cross-section area, prominent dorsal & ventral horns for upper limb. Note: dorsal columns (gracile & cuneate fasciculi) are largest here." },
    { id: "cervical-gray", label: "Cervical (Gray\'s)", img: "img/sc-gray672-cervical.png",
      desc: "Gray\'s Anatomy: Classic illustration showing butterfly gray matter, dorsal horn (sensory), ventral horn (motor), central canal, white matter columns." },
    { id: "thoracic", label: "Thoracic", img: "img/sc-thoracic-cross.svg",
      desc: "T1-T12: Small round cord. Key feature: LATERNAL HORN (intermediolateral cell column) - contains sympathetic preganglionic neurons (T1-L2)." },
    { id: "thoracic-gray", label: "Thoracic (Gray\'s)", img: "img/sc-gray675-thoracic.png",
      desc: "Gray\'s: Shows Clarke\'s nucleus (nucleus dorsalis) at C8-L2 for proprioception, lateral horn clearly visible." },
    { id: "lumbar", label: "Lumbar", img: "img/sc-lumbar-cross.svg",
      desc: "L1-S2: Enlargement for lower limbs. Large ventral horns packed with motor neurons. Reduced white matter vs cervical." },
    { id: "labeled", label: "Labeled Anatomy", img: "img/sc-cross-section-labeled.jpg",
      desc: "Complete labeled: dorsal/ventral horns, dorsal/ventral columns, lateral columns, central canal, posterior median sulcus, anterior median fissure." },
    { id: "tracts-asc", label: "Ascending Tracts", img: "img/sc-gray687-tracts.png",
      desc: "Sensory tracts: Dorsal Columns (gracile/cuneate), Spinothalamic (anterolateral), Spinocerebellar (posterior)." },
    { id: "tracts-desc", label: "Descending Tracts", img: "img/sc-gray688-tracts.png",
      desc: "Motor tracts: Lateral CST (pyramidal), Anterior CST, Rubrospinal, Vestibulospinal, Reticulospinal, Tectospinal." },
  ];
  ...
  return (
    <div style={{ marginTop: 20 }}>
      <h3 style={{ fontFamily: "'Nunito'", fontWeight: 800, fontSize: 18, margin: "0 0 12px", color: "#1F2933" }}>
        🔬 Spinal Cord Levels — Click to Identify
      </h3>
      <div style={{ background: "#fff", borderRadius: 14, padding: 16, boxShadow: "0 2px 12px rgba(0,0,0,0.06)" }}>
        <div style={{ position: "relative", display: "inline-block", width: "100%", maxWidth: 520 }}>
          ...
          {isOverview && current.regions && current.regions.map(r => (
            <div key={r.id} onClick={() => onSelect(r.id)}
              style={{
                position: "absolute", left: "3%", width: "94%", top: r.y, height: r.h,
                border: sel === r.id ? `3px solid ${r.color}` : `2px dashed ${r.color}88`,
                background: sel === r.id ? r.color + "20" : "transparent",
                borderRadius: 8, cursor: "pointer", transition: "all 0.2s",
                display: "flex", alignItems: "center", justifyContent: "center"
              }}>
              <span style={{
                background: r.color, color: "#fff", padding: "4px 12px", borderRadius: 6,
                fontSize: 11, fontWeight: 700, fontFamily: FONTS, opacity: 0.9
              }}>
                {r.label}
              </span>
            </div>
        ...
        <p style={{ fontSize: 13, color: "#333", textAlign: "center", margin: "12px 0 0", lineHeight: 1.5, fontFamily: FONTS, fontWeight: 600 }}>
          {current.desc}
        </p>
        {isOverview && (
          <p style={{ fontSize: 11, color: "#888", textAlign: "center", margin: "8px 0 0", fontFamily: FONTS }}>
            👆 Click a region on the image above to learn more
          </p>
        )}
      </div>
    </div>
