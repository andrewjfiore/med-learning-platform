...
const SpinalCordSVG = ({ highlight = [], lesionRegions = [], onClick, interactive = false, showLabels = true, size = 300 }) => {
  ...
  const tractPaths = {
    ...
    corticospinalL: { d: "M 125 100 Q 118 115 122 135 Q 130 140 133 125 Q 130 110 128 100 Z", color: TRACTS.corticospinal.color, label: "CST", lx: 108, ly: 105 },
    corticospinalR: { d: "M 175 100 Q 182 115 178 135 Q 170 140 167 125 Q 170 110 172 100 Z", color: TRACTS.corticospinal.color, label: "CST", lx: 185, ly: 105 },
    spinocerebellarL: { d: "M 118 90 Q 110 100 112 115 Q 116 118 120 110 Q 122 100 120 90 Z", color: TRACTS.spinocerebellar.color, label: "SCT", lx: 98, ly: 95 },
    spinocerebellarR: { d: "M 182 90 Q 190 100 188 115 Q 184 118 180 110 Q 178 100 180 90 Z", color: TRACTS.spinocerebellar.color, label: "SCT", lx: 194, ly: 95 },
